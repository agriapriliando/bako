                        ...
                        <div class="row">
                            <div class="col-12 mt-0 pt-0">
                                <div class="section-title p-0 m-0">
                                    <h2>Tambah Data Pasar</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
                                <form method="POST" action="{{ url('pasars') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <textarea name="lokasi_gmap" class="form-control" rows="2">{{ old('lokasi_gmap') }}</textarea>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="row justify-content-center position-relative">
                                            <div class="col-md-4 col-12">
                                                <img id="img-preview" class="img-preview" src="https://placehold.co/400x400" alt="your image" />
